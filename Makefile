CLIENT_OBJS = client.o client_main.o render.o texture.o resource.o player.o logic.o render_object.o level.o sha1.o network_lib.o socket.o
SERVER_OBJS = server.o server_main.o player.o level.o sha1.o network_lib.o socket.o
